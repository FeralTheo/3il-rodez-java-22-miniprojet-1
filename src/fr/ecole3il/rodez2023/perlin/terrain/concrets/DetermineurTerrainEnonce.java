...
// Classe permettant de visualiser les différentes caractéristiques du terrain
public class VisualiseurTerrainEnonce {

    // Carte représentant le terrain à visualiser
    private final Carte carte;

    // Constructeur prenant une carte en paramètre
    public VisualiseurTerrainEnonce(Carte carte) {
        this.carte = carte;
    }

    // Méthode pour obtenir l'altitude affichée à une position donnée sur la carte
    ...
    // Méthode pour obtenir l'hydrométrie affichée à une position donnée sur la carte
    ...
    // Méthode pour obtenir la température affichée à une position donnée sur la carte
    ...
    // Méthode pour obtenir le type de terrain à une position donnée sur la carte
